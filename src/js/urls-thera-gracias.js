  ...
  cities.forEach((city) => {
    ...
    camps.forEach((campaignName) => {
      ...
      let text = document.createTextNode(
        `https://megacable-promociones.com.mx/netflix/gracias.php?campaign=${campaignName}&city=${city}&ag=th&page=typ`
      )
      link.appendChild(text)
      link.href = `https://megacable-promociones.com.mx/netflix/gracias.php?campaign=${campaignName}&city=${city}&ag=th&page=typ`
      link.target = "_blank"
